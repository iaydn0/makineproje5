...
st.title("MPG Tahmini - Linear, Ridge Regresyon ve KMeans")

model_name = st.selectbox("Model Seçin", ["Linear Regression", "Ridge Regression", "KMeans (Sınıflandırma Amaçlı)"])
